...
#define MAX_ICMP_SIZE (MAX_SIZE + ICMP_HDR_SIZE)							// max size of an IP datagram
#define MAX_REPLY_SIZE (IP_HDR_SIZE + ICMP_HDR_SIZE + MAX_ICMP_SIZE)		// ICMP Reply message size. Packet size can be larger than this size value
